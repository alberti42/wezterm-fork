...
impl Window {
        ...
        F: 'static + FnMut(WindowEvent, &Window),
    {
        ...
        unsafe {
            ...
            let window: id = msg_send![get_wezterm_window_view_class(), alloc];
...
fn get_wezterm_window_view_class() -> &'static Class {
...
impl WindowView {
    ...
    fn get_class() -> &'static Class {
        Class::get(VIEW_CLS_NAME).unwrap_or_else(Self::get_wezterm_window_class)
    }
